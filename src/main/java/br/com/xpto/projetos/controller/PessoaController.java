...
public class PessoaController {
	...
	public ModelAndView gerenciaExcecoes(RuntimeException ex) {
		ModelAndView modelAndView = new ModelAndView("/pessoaLista", "error",
				messageLocaleService.getMessage("comum.validacao.crud"));
		modelAndView.addObject("pessoas", service.buscaTodos());
		return modelAndView;
	}
}
